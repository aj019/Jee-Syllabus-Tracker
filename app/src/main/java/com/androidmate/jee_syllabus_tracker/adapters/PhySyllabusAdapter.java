...
public class PhySyllabusAdapter extends BaseAdapter {
    ...
    public PhySyllabusAdapter(Context context, ArrayList<String> syllabus, boolean[] checkBoxState) {
        ...
        cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()){
                    ...
                    editor.putString("phystate",state);
                    editor.commit();
                }
