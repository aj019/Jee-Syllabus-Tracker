...
public class MathSyllabusAdapter extends BaseAdapter {
    ...
    public MathSyllabusAdapter(Context context, ArrayList<String> syllabus, boolean[] checkBoxState) {
        ...
        cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()){
                    ...
                    editor.putString("mathstate",state);
                    editor.commit();
                }
