 ...
 */
public class ChemistryCompletedFragment extends Fragment {
    ...
    public ChemistryCompletedFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.chemistry_fragment_completed,container,false);
        ...
        rv = (RecyclerView) v.findViewById(R.id.rvChemistryCompleted);
