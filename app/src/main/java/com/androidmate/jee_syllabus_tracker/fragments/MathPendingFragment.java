...
public class MathPendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.math_fragment_pending,container,false);
        ...
        rv = (RecyclerView) v.findViewById(R.id.rvMathPending);
